  ...
  function InnerSlider(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "UNSAFE_componentWillMount", function () {
      ...
      if (_this.props.lazyLoad) {
        var slidesToLoad = Object(_utils_innerSliderUtils__WEBPACK_IMPORTED_MODULE_5__["getOnDemandLazySlides"])(_objectSpread(_objectSpread({}, _this.props), _this.state));
    ...
    _defineProperty(_assertThisInitialized(_this), "ssrInit", function () {
      if (_this.props.variableWidth) {
        var _trackWidth = 0,
            _trackLeft = 0;
        var childrenWidths = [];
        var preClones = Object(_utils_innerSliderUtils__WEBPACK_IMPORTED_MODULE_5__["getPreClones"])(_objectSpread(_objectSpread(_objectSpread({}, _this.props), _this.state), {}, {
          slideCount: _this.props.children.length
        }));
        var postClones = Object(_utils_innerSliderUtils__WEBPACK_IMPORTED_MODULE_5__["getPostClones"])(_objectSpread(_objectSpread(_objectSpread({}, _this.props), _this.state), {}, {
          slideCount: _this.props.children.length
        }));
    ...
    _defineProperty(_assertThisInitialized(_this), "slideHandler", function (index) {
      ...
      var _slideHandler = Object(_utils_innerSliderUtils__WEBPACK_IMPORTED_MODULE_5__["slideHandler"])(_objectSpread(_objectSpread(_objectSpread({
        index: index
      }, _this.props), _this.state), {}, {
        trackRef: _this.track,
    ...
    _defineProperty(_assertThisInitialized(_this), "swipeMove", function (e) {
      var state = Object(_utils_innerSliderUtils__WEBPACK_IMPORTED_MODULE_5__["swipeMove"])(e, _objectSpread(_objectSpread(_objectSpread({}, _this.props), _this.state), {}, {
        trackRef: _this.track,
        listRef: _this.list,
    ...
    _defineProperty(_assertThisInitialized(_this), "swipeEnd", function (e) {
      var state = Object(_utils_innerSliderUtils__WEBPACK_IMPORTED_MODULE_5__["swipeEnd"])(e, _objectSpread(_objectSpread(_objectSpread({}, _this.props), _this.state), {}, {
        trackRef: _this.track,
        listRef: _this.list,
        slideIndex: _this.state.currentSlide
      }));
    ...
    _defineProperty(_assertThisInitialized(_this), "play", function () {
      ...
      if (_this.props.rtl) {
        ...
        if (Object(_utils_innerSliderUtils__WEBPACK_IMPORTED_MODULE_5__["canGoNext"])(_objectSpread(_objectSpread({}, _this.props), _this.state))) {
          nextIndex = _this.state.currentSlide + _this.props.slidesToScroll;
        } else {
          return false;
        }
    ...
    _defineProperty(_assertThisInitialized(_this), "render", function () {
      ...
      if (_this.props.dots === true && _this.state.slideCount >= _this.props.slidesToShow) {
        ...
        dots = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_dots__WEBPACK_IMPORTED_MODULE_7__["Dots"], dotProps);
      }
      ...
      if (_this.props.arrows) {
        prevArrow = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_arrows__WEBPACK_IMPORTED_MODULE_8__["PrevArrow"], arrowProps);
        nextArrow = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_arrows__WEBPACK_IMPORTED_MODULE_8__["NextArrow"], arrowProps);
      }
      ...
      }, listProps), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_track__WEBPACK_IMPORTED_MODULE_6__["Track"], _extends({
    ...
    _this.list = null;
    _this.track = null;
    _this.state = _objectSpread(_objectSpread({}, _initial_state__WEBPACK_IMPORTED_MODULE_2__["default"]), {}, {
  ...
  _createClass(PrevArrow, [{
    ...
    value: function render() {
      ...
      if (this.props.prevArrow) {
        prevArrow = react__WEBPACK_IMPORTED_MODULE_0___default.a.cloneElement(this.props.prevArrow, _objectSpread(_objectSpread({}, prevArrowProps), customProps));
      } else {
  ...
  _createClass(NextArrow, [{
    ...
    value: function render() {
      ...
      if (this.props.nextArrow) {
        nextArrow = react__WEBPACK_IMPORTED_MODULE_0___default.a.cloneElement(this.props.nextArrow, _objectSpread(_objectSpread({}, nextArrowProps), customProps));
      } else {
